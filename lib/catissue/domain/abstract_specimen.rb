...
module CaTissue
  class AbstractSpecimen
    ...
    # quirk caTissue The AbstractSpecimen -> SpecimenEventParameters association property is
    #   named  +event_parameters+, whereas the SpecimenCollectionGroup -> SpecimenEventParameters
    #   association property is named +specimen_event_parameters+. caRuby aliases these
    #   properties in both AbstractSpecimen and SpecimenCollectionGroup so that they can
    ...
    add_dependent_attribute(:specimen_events, :disjoint)
