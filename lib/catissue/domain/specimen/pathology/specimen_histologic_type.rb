module CaTissue
  class Specimen
    class Pathology
      # caTissue alert - The 1.1 class HistologicType is renamed to SpecimenHistologicType in 1.2.
      ...
      class SpecimenHistologicType
        # caTissue alert - The SpecimenHistologicType => SpecimenHistologicVariantType collection
