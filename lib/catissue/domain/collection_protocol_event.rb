...
module CaTissue
  ...
  class CollectionProtocolEvent
    ...
    # @quirk caTissue The CollectionProtocolEvent +specimen_collection_groups+ reference is
    #    unnecessary and expensive to maintain inverse integrity. The SCG event attribute is required,
    #    but adding the SCG to the event SCG inverse attribute value requires loading all of the SCGs.
    #    +specimen_collection_groups+ is not used in practice. The event SCGs can be easily obtained
    #    by a query.
